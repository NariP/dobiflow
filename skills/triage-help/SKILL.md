...
Read `${CLAUDE_PLUGIN_ROOT}/docs/triage-workflow-guide.md` and show the user a **summary of the essentials**.
If an argument is given (e.g. `/triage-help approval`), extract and explain only that topic.

## Behavior
1. Read `${CLAUDE_PLUGIN_ROOT}/docs/triage-workflow-guide.md`.
...
```
Full guide: `${CLAUDE_PLUGIN_ROOT}/docs/triage-workflow-guide.md`
