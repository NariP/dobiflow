...
// triage.config.json
{
  ...
  "models": {
    ...
    // 계획·판단·검증류=상위 모델 / 판단 없는 "손"(git-writer)=하위. (Claude 진영 예 — Codex는 gpt 상·하위)
